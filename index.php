	...
	<div class="hero-wrap js-fullheight" style="background-image: url('images/bg-img-4.png');">
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				...
				<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&pp=ygUJcmljayByb2xs" class="icon-video popup-vimeo d-flex align-items-center justify-content-center mb-4">
