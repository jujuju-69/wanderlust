...
// Modify the query to filter destinations by location 'Melaka'
$query = $conn->query("SELECT * FROM destinations WHERE location = 'Melaka'");
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         ...
         <h1 class="mb-0 bread">Tour in Melaka</h1>
     </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <?php else: ?>
        <div class="col-md-12 ftco-animate text-center">
          <p>No destinations found in Melaka.</p>
        </div>
      <?php endif; ?>
    </div>
  </div>
