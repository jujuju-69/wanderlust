...
// Modify the query to filter destinations by location 'Kelantan'
$query = $conn->query("SELECT * FROM destinations WHERE location = 'Kelantan'");
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         ...
         <h1 class="mb-0 bread">Tour in Kelantan</h1> <!-- Changed from Perlis to Kelantan -->
     </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <?php else: ?>
        <div class="col-md-12 ftco-animate text-center">
          <p>No destinations found in Kelantan.</p> <!-- Changed from Perlis to Kelantan -->
        </div>
      <?php endif; ?>
    </div>
  </div>
