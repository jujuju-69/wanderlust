      ...
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-1 d-block img" style="background-image: url(images/services-1.jpg);">
          ...
          <h3 class="heading mb-3">Activities</h3>
            <p>Exploring local markets and participating in adventure sports are fun activities that make touring exciting and memorable.</p>
          </div>
        </div>      
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-2 d-block img" style="background-image: url(images/services-2.jpg);">
          ...
          <div class="media-body">
            ...
            <p>
            Planning travel arrangements includes booking flights, arranging accommodations, and organizing itineraries to ensure a smooth and enjoyable journey.</p>
          </div>
        </div>    
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-3 d-block img" style="background-image: url(images/services-3.jpg);">
          ...
          <div class="media-body">
            ...
            <p>
            Hiring a private guide enhances your travel experience by offering personalized tours, in-depth knowledge of local attractions, and tailored recommendations for an unforgettable adventure.</p>
          </div>
        </div>      
      </div>
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-4 d-block img" style="background-image: url(images/services-4.jpg);">
          ...
          <div class="media-body">
            ...
            <p>
            A location manager ensures seamless travel by coordinating logistics, securing permits, and managing venues, making sure every aspect of your journey or event runs smoothly.</p>
          </div>
        </div>      
      </div>
    </div>
