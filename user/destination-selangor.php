...
// Modify the query to filter destinations by location 'Selangor'
$query = $conn->query("SELECT * FROM destinations WHERE location = 'Selangor'");
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
         ...
         <h1 class="mb-0 bread">Tour in Selangor</h1> <!-- Updated from Perlis to Selangor -->
     </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <?php else: ?>
        <div class="col-md-12 ftco-animate text-center">
          <p>No destinations found in Selangor.</p> <!-- Updated message -->
        </div>
      <?php endif; ?>
    </div>
  </div>
