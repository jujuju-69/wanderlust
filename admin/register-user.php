...
<body>
    <div class="login">
        ...
        <form action="act_register.php" method="POST" class="login__form">
            ...
            <div class="login__content">
                <div class="login__box">
                    ...
                    <div class="login__box-input">
                        <input type="text" required class="login__input" id="login-firstname" name="fullname" placeholder=" ">
                ...
                <div class="login__box">
                    ...
                    <div class="login__box-input">
                        <input type="password" required class="login__input" id="login-password" name="password" placeholder=" ">
    ...
    <script>
        function redirectToLogin() {
            // Redirect to login-user.php after form submission
